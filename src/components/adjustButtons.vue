<template>
    <div class="svgButtonsGroup overflow-hidden h-full flex flex-row justify-end items-center gap-8">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 163 176" class="icon1 w-20" >
            <polygon class="cls-2 cursor-pointer" points="0 0 163 16 151 176 9 166 0 0" @click="setView('reset')"/>
            <path class="cls-1 cursor-pointer" d="m29,23l116,11-9,121s-113.04-7.25-113.5-7.5,6.5-124.5,6.5-124.5Z" @click="setView('reset')"/>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 322 179.98" class="icon2 w-40">
            <g class="cursor-pointer" @mousedown="startSetView('zoomIn')" @mouseup="endSetView" @mouseleave="endSetView">
                <polygon class="cls-2"
                    points="0 32.98 14.27 179.98 179.83 179.98 181.46 166.12 181.59 166.1 126.93 34.98 0 32.98" />
                <polygon class="cls-1"
                    points="15 43.98 24.66 166.12 163 157.98 163 146.03 173.25 146.1 131.84 46.76 15 43.98" />
                <polygon class="cls-3"
            ...
            <g class="cursor-pointer" @mousedown="startSetView('zoomOut')" @mouseup="endSetView" @mouseleave="endSetView">
                ...
                <polygon class="cls-1"
                    points="307 14.98 138 27.98 141 46.98 131.84 46.76 173.25 146.1 305 146.98 307 14.98" />
                <polygon class="cls-3"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 566 273.5" class="icon3 w-50">
            <g class="cursor-pointer" @mousedown="startSetView('moveDown')" @mouseup="endSetView" @mouseleave="endSetView">
                <polygon class="cls-2"
                    points="125 38.17 125 67 124.98 67 174.03 231 281.67 214.76 295.68 38.17 125 38.17" />
                <polygon class="cls-1"
            ...
            <g class="cursor-pointer" @mousedown="startSetView('moveRight')" @mouseup="endSetView" @mouseleave="endSetView">
            ...
            <g class="cursor-pointer" @mousedown="startSetView('moveLeft')" @mouseup="endSetView" @mouseleave="endSetView">
                <polygon class="cls-2"
                    points="369 0 376 38.17 306 49 311.93 38.17 295.68 38.17 281.67 214.76 300 212 298 200 433.21 174.65 374.33 .3 369 0" />
            ...
            <g class="cursor-pointer" @mousedown="startSetView('moveUp')" @mouseup="endSetView" @mouseleave="endSetView">
