<template>
    <div class="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 w-1/2 h-1/2 select-none pointer-events-none">
        <svg id="_设置组件" data-name="设置组件" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1113.61 652.2"
            class="main z-50 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full">
            <g id="_主体" data-name="主体" class="pointer-events-auto">
                ...
                <polygon class="cls-2" points="862.79 98.28 735.94 139.64 543.92 347.44 733.25 217.77 862.79 98.28" />
        ...
        <div class="group relative h-full w-full z-[100] whitespace-nowrap">
            ...
            <div class="absolute flex flex-col items-center justify-center h-1/12 w-1/9">
                <h1 class="text-2xl text-white">坐标轴类型</h1>
                <select class="select text-black bg-[#C8C8C8] focus:outline-none focus:border-[#C8C8C8] w-9/10" v-model="userConfig.chartType" @change="updateUserConfig">
            ...
            <div class="absolute flex flex-col items-center justify-center h-1/10 w-1/6">
                ...
                <input type="checkbox" checked="checked" class="toggle checked:bg-neutral-700 checked:text-[#AEA181] checked:border-[#978c70]"
