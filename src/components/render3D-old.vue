...
export default {
    ...
    methods: {
        init() {
            ...
            // 添加场景边界盒
            this.boundingBox = this.createSceneBoundingBox();
        ...
        createSceneBoundingBox() {
            ...
            this.camera.left = -boxSize / 2;
            this.camera.right = boxSize / 2;
            this.camera.top = boxSize / 2;
            this.camera.bottom = -boxSize / 2;
            this.camera.near = 0.1;
            this.camera.far = boxSize * 5;
            this.camera.updateProjectionMatrix();
        ...
        animate() {
            ...
            this.renderer.render(toRaw(this.scene), markRaw(this.camera));
            // 每帧更新前回调'animate()'函数
